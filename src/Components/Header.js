            ...
            <>
             <header className="header row">
                 ...
                 <div className="col-xl-6 col-md-5 col-lg-5">
                  <ul>
                  <li><NavLink exact to="daily-focus/">HOME</NavLink></li>
                  <li><NavLink to="daily-focus/world">WORLD</NavLink></li>
                  <li><NavLink to="daily-focus/art">ART</NavLink></li>
                  <li><NavLink to="daily-focus/science">SCIENCE</NavLink></li>
